 var buttons = ["penguin", "ponyo", "dolphin", "Amber Rose", "lion", "cheetah", "tiger"];
...
function displayGifInfo() {
  ...
  $.ajax({
    ...
    for (var i = 0; i < response.data.length; i++) {
      ...
      newImage.attr("image-animate", response.data[i].images.fixed_height.url);
      $("#image-dump").prepend("<span class='ratingSpan'> Rating: " + response.data[i].rating + "</span>");
